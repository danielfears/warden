...
echo 'echo "***  AZURE CREDENTIALS HAVE BEEN SUCCESSFULLY LOADED  ***"' >> ~/azuredulous/azuredulous.sh
echo 'echo ""' >> ~/azuredulous/azuredulous.sh
...
echo 'echo ""' >> ~/azuredulous/uninstall.sh
